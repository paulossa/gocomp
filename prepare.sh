...
java -jar eclipseWorkspace/GoTranslator/lib/jflex-1.6.1.jar -d eclipseWorkspace/GoTranslator/src/go/core/ --nobak eclipseWorkspace/GoTranslator/spec/rules.flex
