...
public class CodeGenerator {
	...
	private String initAssemblyCode() {
		return labels + ": LD SP, 4000\n";
	}
	
	public void declareVar(Identifier id, Expression expression) throws Exception {
		// TODO Auto-generated method stub
		generateLDCode(id);
		id.setValue(expression.getValue());
		generateSTCode(id);
	}
...
//	}
	...
	public void generateADDCode(Register result, Register one, Expression exp) throws Exception {
		labels += 8;
	...
	public void generateSUBCode(Register result, Register one, Expression exp) throws Exception {
		labels += 8;
...
//	}
	...
	public void generateLDCode(Identifier id) {
		if (id.getName() != null) {
			register++;
			labels += 8;
			addCode(labels + ": LD " + allocateRegister() + ", " + id.getName());
		}
	}
//
	public void generateSTCode(Identifier variable) {
		labels += 8;
		addCode(labels + ": ST " + variable.getName() + ", " + variable.getValue());
		this.register = -1;
	}
//
